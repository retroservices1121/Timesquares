...
export default function Home(){const [selected,setSelected]=useState(1);const pick=useCallback((rank:number)=>setSelected(rank),[]);const ad=leaders[selected-1];return <main className="square-shell babylon-page">
  ...
  <section className="square-hud"><div><i/> 30 LIVE BILLBOARDS</div><strong>TOP 5 OWN<br/>THE SKYLINE.</strong><span>Walk the full strip · Drag to look · Click any screen</span><a href="/dashboard/bid">TAKE A BILLBOARD ↗</a></section>
