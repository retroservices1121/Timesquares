...
const leaders=[{rank:1,name:'VOIDLABS',bid:'$12,500'},{rank:2,name:'AURORA®',bid:'$8,420'},{rank:3,name:'KINETIC',bid:'$6,180'},{rank:4,name:'NOVA.FM',bid:'$4,900'},{rank:5,name:'PIXEL.FUN',bid:'$3,740'}];
export default function Home(){const [selected,setSelected]=useState(1);const pick=useCallback((rank:number)=>setSelected(rank),[]);const ad=leaders[selected-1];return <main className="square-shell babylon-page">
  ...
  <section className="square-hud"><div><i/> 3D LIVE LEADERBOARD</div><strong>BID MORE.<br/>MOVE UP THE SQUARE.</strong><span>Drag to orbit · Scroll to zoom · Click a billboard</span><a href="/dashboard/bid">TAKE A BILLBOARD ↗</a></section>
