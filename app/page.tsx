...
export default function Home() {
  ...
  return <main className="square-shell">
    ...
    <section className="hero-copy"><p>THE WORLD&apos;S MOST COMPETITIVE AD SPACE</p><h1>Own the biggest<br/>billboard on the internet.</h1><span>Bid your way up the square. The bigger the bid, the bigger the billboard.</span><div className="hero-actions"><a className="primary-btn" href="/dashboard/bid">GET A BILLBOARD <b>↗</b></a><a className="text-btn" href="/leaderboard">VIEW LEADERBOARD <b>→</b></a></div></section>
