...
export const rankBids=(bids:RankedBid[])=>[...bids].sort((a,b)=>b.amount-a.amount||a.createdAt.localeCompare(b.createdAt)).map((bid,index)=>({...bid,rank:index+1,billboardId:index<64?`billboard_${String(index+1).padStart(2,'0')}`:null}));
